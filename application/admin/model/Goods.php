...
class Goods extends Model
{
    ...
    protected $rule = [
        'goods_name|商品名称'    => 'require|unique:goods',
    ...
    //获取数据列表，不分页
    public function GetDataList($where=array(), $order='goods_is_top desc,goods_rank desd')
    {
    ...
    {
        return $this->where('goods_id',$id)->delete() ? array('code'=>1,'msg'=>'删除成功') : array('code'=>0,'msg'=>'删除失败');
    }
}