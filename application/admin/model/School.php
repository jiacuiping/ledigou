...
class School extends Model
{
     ...
     **/
    public function GetListByPage($where=array(), $page=1, $limit=10, $order='school_id desc')
    {   
        return $this->where($where)->page($page,$limit)->order($order)->select();
    }

    //获取数据列表，不分页
    public function GetDataList($where=array(), $order='school_id desc')
    {
    ...
    {
        return $this->where('school_id',$id)->find();
    }
    ...
    public function UpdateData($param)
    {
        ...
        $res = $this->allowField(true)->save($param, ['school_id' => $param['school_id']]);
    ...
    {
        return $this->where('school_id',$id)->delete() ? array('code'=>1,'msg'=>'删除成功') : array('code'=>0,'msg'=>'删除失败');
    }
}