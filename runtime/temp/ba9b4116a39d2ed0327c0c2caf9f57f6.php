<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/thebestwe/public/../application/admin/view/rotate/create.html";i:1562719381;}*/ ?>
        ...
        <form class="layui-form" action="" lay-filter="component-form-group" id="myform">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              ...
              <input type="hidden" name="rotate_img" id="imginput">
            </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="rotate_desc"  autocomplete="off" placeholder="请输入轮播图描述" class="layui-input">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="rotate_href"  autocomplete="off" placeholder="请输入轮播图跳转链接，为空则不跳转" class="layui-input">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="number" name="rotate_rank"  autocomplete="off" placeholder="请输入轮播图权重，数字越大越靠前" class="layui-input">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="radio" name="rotate_status" value="1" title="展示" checked="">
              <input type="radio" name="rotate_status" value="0" title="不展示">
            </div>
          </div>
