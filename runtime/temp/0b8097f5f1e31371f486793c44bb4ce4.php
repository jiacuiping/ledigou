<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/wwwroot/thebestwe/public/../application/index/view/user/income.html";i:1563357183;s:59:"/www/wwwroot/thebestwe/application/index/view/base/nav.html";i:1563357453;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="mui-content">
          ...
          <div class="mui-col-xs-4 right chaxun-right">
              <button class="mui-btn">查询</button>
          </div>
          <div></div>
      </div>
      ...
      <div class="index3-list2"><p>收入明细</p></div>
        ...
        <div class="rider-index">
            <div class="rider-xiadan clear">
                <div class="mui-col-xs-9 left rider-xiadan2 rider-xiadan30">
                    ...
                    <p class="h-yichu" style="color: #918f92"><?php echo date('Y-m-d H:i',$item['order_paytime']); ?></p>
                </div>
                <div class="mui-col-xs-3 left rider-xiadan3">
                    <span>+<?php echo $item['commission']; ?></span>元
                </div>
            </div>
        </div>
