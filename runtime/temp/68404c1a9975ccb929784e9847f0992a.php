<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/www/wwwroot/ledigou/public/../application/admin/view/goods/create.html";i:1572503299;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="layui-card-body" style="padding: 15px;">
        <form class="layui-form" action="" lay-filter="component-form-group" id="myform">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input  type="text" name="goods_spec"  autocomplete="off" placeholder="请输入商品规格，如：50g/袋" class="layui-input">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input  type="number" name="goods_rank"  autocomplete="off" placeholder="请输入商品权重，权重越大排序越靠前，最大127" class="layui-input">
            </div>
          </div>
          ...
          <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
              <script id="editor" name="goods_info" type="text/plain" style="width:1000px;height:500px;"></script>
