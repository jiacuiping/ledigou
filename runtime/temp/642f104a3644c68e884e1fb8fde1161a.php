<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/thebestwe/public/../application/admin/view/member/index.html";i:1562985907;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                        ...
                        <form class="layui-form" style="display: flex;float: left;width: 1000px;" id="myform">
                            ...
                            <div class="layui-form-item" style="margin-left: 15px">
                                <div class="layui-input-block">
                                    <input type="text" name="name" autocomplete="off" placeholder="用户名筛选" class="layui-input" value="<?php echo $condition['name']; ?>">
                                </div>
                            </div>
