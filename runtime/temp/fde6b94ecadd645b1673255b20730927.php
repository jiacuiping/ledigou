<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/ledigou/public/../application/admin/view/setting/index.html";i:1570519542;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-card">
      ...
      <div class="layui-card-body" style="padding: 15px;">
        <form class="layui-form" action="" lay-filter="component-form-group" id="myform">
          ...
          <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
            <legend>网站其他项设置</legend>
          </fieldset>

            <div class="layui-form-item">
                <label class="layui-form-label">运费金额设置</label>
                <div class="layui-input-block">
                  <input type="text" name="website_freight" autocomplete="off" placeholder="请输入小程序商城运费" value="<?php echo $info['website_freight']; ?>" class="layui-input">
                </div>
            </div>
