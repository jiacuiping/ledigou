<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/www/wwwroot/ledigou/public/../application/index/view/user/index.html";i:1563862551;s:57:"/www/wwwroot/ledigou/application/index/view/base/nav.html";i:1563862922;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
  ...
  <div class="mui-content">
      ...
      <div class="index3-body">
          <ul class="mui-table-view">
              ...
              <li class="mui-table-view-cell">
                  <a class="mui-navigate-right" href="<?php echo url('order'); ?>">
