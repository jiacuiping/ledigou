<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpstudy_pro\WWW\ledigou\public/../application/admin\view\goods\index.html";i:1575525354;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                            ...
                            <form class="layui-form" style="display: flex;float: left;width: 1000px;" id="myform">
                                ...
                                <div class="layui-form-item" style="margin-left: 15px">
                                    <div class="layui-input-block">
                                        <input type="text" name="name" autocomplete="off" placeholder="商品名筛选" class="layui-input" value="<?php echo $condition['name']; ?>">
                                    </div>
                                </div>
                    ...
                    <div class="layui-card-body">
                        ...
                        <script type="text/html" id="test-table-toolbar-toolbarDemo">
                            <div class="layui-btn-container">
                                <button class="layui-btn layui-btn-sm" id="create">添加商品</button>
                            </div>
                        </script>

                        <script type="text/html" id="test-table-switchTpl">
                            <input type="checkbox" name="goods_status" lay-skin="switch" lay-text="展示|不展示" lay-filter="test-table-sexDemo"
                            value="{{ d.goods_id }}" {{ d.goods_status == 1 ? 'disabled' : '' }} data-json="{{ encodeURIComponent(JSON.stringify(d)) }}" {{ d.goods_status == 1 ? 'checked' : '' }}>
                        </script>
    ...
    <script>
        ...
        layui.config({
            ...
            table.render({
                ...
                ,cols: [[
                        {type: 'checkbox'}
                        ,{field:'goods_id', title:'ID', width:100, unresize: true, sort: true}
                        ,{field:'goods_name', title:'商品名称', sort: true}
                        ,{field:'goods_price', title:'商品价格', sort: true}
                        ,{field:'goods_reserve', title:'商品库存', sort: true}
                        ,{field:'goods_sort', title:'商品分类', minWidth:80, sort: true}
                        ,{field:'goods_status', title:'商品状态', width:120, templet: '#test-table-switchTpl', unresize: true}
                        ,{field:'goods_time', title:'创建时间', minWidth:80, sort: true}
            ...
            function RenderingTable(status=-1,where=array())
            {
                ...
                var tableIns = table.render({
                    ...
                    ,cols: [[
                            ...
                            ,{field:'goods_reserve', title:'商品库存'}
                            ,{field:'goods_sort', title:'商品分类', minWidth:80, sort: true}
                            ,{field:'goods_status', title:'商品状态', width:120, templet: '#test-table-switchTpl', unresize: true}
                            ,{field:'goods_time', title:'创建时间', minWidth:80, sort: true}
                            ,{title:'操作', width:178, align:'center', fixed: 'right', toolbar: '#test-table-operate-barDemo'}
