<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:116:"/Users/xinjiashuodemac/workspace/gaoqiwangluo/xiaochengxu/public/../application/admin/view/index/control_center.html";i:1554695321;}*/ ?>
                  ...
                  <div carousel-item>
                    <ul class="layui-row layui-col-space10">
                      <li class="layui-col-xs3">
                        <a lay-href="<?php echo url('index/StatisticsCenter'); ?>">
                          <i class="layui-icon">&#xe62d;</i> 
                          <cite>统计中心</cite>
                        </a>
                      </li>
                      <li class="layui-col-xs3">
                        <a lay-href="<?php echo url('index/DataCenter'); ?>">
                          <i class="layui-icon">&#xe629;</i> 
                          <cite>数据中心</cite>
                        </a>
                      </li>
            ...
            <table class="layui-table">
              ...
              <tbody>
                <tr>
                  <td>网站网址</td>
                  <td>
                    <script type="text/html" template>http://www.leesin.xin</script>
                  </td>
                </tr>
                <tr>
                  <td>开发框架</td>
                  <td>
                    <script type="text/html" template>
                      Think PHP、Layui、LayuiAdmin
                    </script>
                 </td>
                </tr>
                <tr>
                  <td>贡献者</td>
                  <td>Supreme、Ms bai</td>
                </tr>
                <tr>
                  <td>获取渠道</td>
