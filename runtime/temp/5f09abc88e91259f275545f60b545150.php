<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\phpstudy_pro\WWW\ledigou\public/../application/admin\view\sort\index.html";i:1575525366;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                        ...
                        <form class="layui-form" style="display: flex;float: left;width: 1000px;" id="myform">
                            ...
                            <div class="layui-form-item" style="margin-left: 15px">
                                <div class="layui-input-block">
                                    <input type="text" name="name" autocomplete="off" placeholder="分类名筛选" class="layui-input" value="<?php echo $condition['name']; ?>">
                                </div>
                            </div>
                    ...
                    <div class="layui-card-body">
                        ...
                        <script type="text/html" id="test-table-toolbar-toolbarDemo">
                            <div class="layui-btn-container">
                                <button class="layui-btn layui-btn-sm" id="create">添加分类</button>
                            </div>
                        </script>

                        <script type="text/html" id="test-table-switchTpl">
                            <input type="checkbox" name="sort_status" lay-skin="switch" lay-text="正常|禁用" lay-filter="test-table-sexDemo"
                            value="{{ d.sort_id }}" {{ d.sort_status == 1 ? 'disabled' : '' }} data-json="{{ encodeURIComponent(JSON.stringify(d)) }}" {{ d.sort_status == 1 ? 'checked' : '' }}>
                        </script>
        ...
        layui.config({
            ...
            table.render({
                ...
                ,cols: [[
                        ...
                        ,{field:'sort_icon', title:'分类图标'}
                        ,{field:'sort_rank', title:'分类权重'}
                        ,{field:'sort_status', title:'分类状态', width:120, templet: '#test-table-switchTpl', unresize: true}
