<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpstudy_pro\WWW\ledigou\public/../application/admin\view\order\refund.html";i:1575946437;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'order_refund', title:'退款进度', width:120, templet: '#test-table-switchTpl', unresize: true}
