    ...
    <script>
        layui.config({
            ...
            $("body").on('click','.showrecord',function(){
                ...
                var url = "<?php echo url('showrecord','',false); ?>/id/" + $(this).attr('data-id');
                layer.open({
                    type: 2
                    ,title:'查看订单记录'
                    ,content: url
            ...
            $("body").on('click','.showother',function(){
                ...
                var url = "<?php echo url('showother','',false); ?>/id/" + $(this).attr('data-id')+"/type/"+$(this).attr('data-type');
                layer.open({
                    type: 2
                    ,title:'查看记录'
                    ,content: url
            ...
            $("body").on('click','.commissionrecord',function(){
                ...
                var url = "<?php echo url('commissionrecord','',false); ?>/id/" + $(this).attr('data-id');
                layer.open({
                    type: 2
                    ,title:'查看佣金记录'
                    ,content: url
            ...
            $("body").on('click','.pricerecord',function(){
                ...
                var url = "<?php echo url('pricerecord','',false); ?>/id/" + $(this).attr('data-id');
                layer.open({
                    type: 2
                    ,title:'查看收益记录'
                    ,content: url
