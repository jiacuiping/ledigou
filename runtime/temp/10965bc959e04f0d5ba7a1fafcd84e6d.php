<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/ledigou/public/../application/index/view/headshare/list.html";i:1563934574;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
      ...
      <?php if(is_array($goods) || $goods instanceof \think\Collection || $goods instanceof \think\Paginator): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
        <div class="l-zong">
            ...
            <div class="l-zi">
                ...
                <a href="<?php echo url('info',array('goods_id'=>$item['goods_id'])); ?>"><button class="mui-btn tg-btn">立即购买</button></a>
            </div>
        </div>
